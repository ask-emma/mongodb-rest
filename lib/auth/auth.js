...
module.exports = function(app, config) {
  ...
  if (!config.auth.usersDBConnection) {
    throw new Error(
      "Authentication has been enabled by including 'auth' in the configuration, but users database connection string 'usersDBConnection' has not been specified.",
    )
  }

  if (!config.auth.tokenDBConnection) {
    throw new Error(
      "Authentication has been enabled by including 'auth' in the configuration, but tokens database connection string 'tokenDBConnection' has not been specified.",
    )
  }
